    ...
    <section id="map" className="section-padding" style={{ background: 'var(--bg-secondary)' }}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          */}
          <iframe
            src="https://maps.google.com/maps?q=Mirador+Del+Sur+Joaquín+Balaguer+Park,+Santo+Domingo,+Dominican+Republic&t=&z=15&ie=UTF8&iwloc=&output=embed"
            width="100%"
            height="450"
            style={{ border: 0 }}
            allowFullScreen
            ...
            title="Google Maps - Mirador Del Sur Joaquín Balaguer Park"
          />
        </div>
